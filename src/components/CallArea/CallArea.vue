...
const {fullscreenElement, isFull, existFullScreen, fullScreen} = useFullScreen()
        ...
        <div class="header">
          ...
          >
            <el-button @click="fullScreen">
              <template #icon>
                <el-icon size="22">
                  <svg v-show="!isFull" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    <path fill="currentColor"
                          d="M4 4h6v2H6v4H4zm10 0h6v6h-2V6h-4zM6 14v4h4v2H4v-6zm14 0v6h-6v-2h4v-4z"/>
                  </svg>
                  <svg v-show="isFull" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    <path fill="currentColor"
                          d="M14 20v-6h6v2h-4v4zm-6 0v-4H4v-2h6v6zm12-10h-6V4h2v4h4zm-10 0H4V8h4V4h2z"/>
                  </svg>
                </el-icon>
              </template>
            </el-button>
